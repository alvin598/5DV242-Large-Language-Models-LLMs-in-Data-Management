...
rules = [
    ["S","NP VP"],
    ["Q","who does NP V # NP $"],
    ["R","if X1 hates X2 and X3 bites X2 then X1 loves X3"],
    ["R","if X1 bites X2 and X3 bites X2 then X1 loves X3"],
    ["R","if X1 loves X2 and X2 hates X3 then X1 hates X3"],
    ["R","if X1 loves X2 and X2 loves X3 then X1 loves X3"],
...
with open("reasoning.txt", "w") as my_file:
